...
public class SudokuFrame extends JFrame {
    ...
    private JPanel buildFooter() {
        ...
        // New Game
        JButton newGameBtn = createButton("New Game", COL_ACCENT, Color.WHITE);
        ...
        // Hint
        JButton hintBtn = createButton("Hint 💡", new Color(80, 180, 120), Color.WHITE);
    ...
    private void navigate(int dr, int dc) {
        ...
        int nr = Math.max(0, Math.min(8, r + dr));
        int nc = Math.max(0, Math.min(8, c + dc));
    ...
    public void flashMistake() {
        ...
        mistakeFlashTimer = new Timer(600, e -> mistakesLabel.setForeground(Color.WHITE));
