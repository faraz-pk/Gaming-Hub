 ...
 * Renders the 9×9 grid of SudokuCell objects with proper
 * thick borders between 3×3 boxes and thin borders between cells.
 * OOP Concepts: Composition (contains SudokuCell objects), Encapsulation
 */
