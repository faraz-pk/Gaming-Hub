...
public class SudokuCell extends JPanel {
    ...
    public enum CellState {
        NORMAL, SELECTED, CONFLICT, HINT, RELATED
    }
    ...
    private static final Font FONT_FIXED = new Font("Segoe UI", Font.BOLD,  22);
    private static final Font FONT_USER  = new Font("Segoe UI", Font.PLAIN, 22);
